...
const Hero = () => {
  return (
    <section className="bg-[#909590] rounded-lg p-8 mb-12">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-5xl font-bold mb-8">Hi, I'm Oscar</h1>
        <p className="text-xl mb-12">
          Recent Computer Science graduate from McGill University with a passion for building creative and user-friendly web applications. Currently seeking opportunities in software development and creative technology.
        </p>
